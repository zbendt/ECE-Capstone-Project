...
class ImageProcessingThread(QtCore.QThread):
    ...
    def run(self):
        ...
        self.sig.nextSample.connect(self.nextSample)
...
class Ui_MicrobialAnalysis(object):
    def setupUi(self, MicrobialAnalysis):
        ...
        self.connect(self.thread1, SIGNAL("updateLabels(Qstring)"), self.updateLabels)       
    ...
    def start_clicked(self):
        ...
        CUR_SAMPLE = 1                                                #current sample number 
        self.thread1.start()
        
    def updateLabels(self, sample_num, test_res, col_cnt):
    
    
        cur_samp_text = str(sample_num)                               #update labels
        self.sampleNumber.setText(cur_samp_text)                  
        self.passFail.setText(test_res)
        self.colonyCount.setText(col_cnt)
    ...
    def done(self):
        ...
        QtGui.QMessageBox.information(self, "Analysis Complete", "Please remove samples.")
