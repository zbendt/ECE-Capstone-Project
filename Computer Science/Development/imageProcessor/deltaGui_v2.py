...
import deltaImageProcessor as analysis
...
class Worker(QRunnable):
    ...
    def __init__(self, fn):
        ...
        #self.grblCom = GRBL.SerialObj("COM3")
    ...
    def run(self):
        ...
        output_file = open('/home/pi/Documents/deltaImageProcessor/Database/output.csv', 'w')
        data_writer = csv.writer(output_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
        data_writer.writerow(['Client Name', 'Sample Number', 'Colony Count', 'Test Result'])
        #while(CUR_SAMPLE+1 < TOTAL_SAMPLES):
        ...
        if(END == True):
            ...
            COL_COUNT = analysis.AnalyzeSample(CUR_SAMPLE) #run analysis
            ...
            data = [CLIENT_NAME, str(CUR_SAMPLE), str(COL_COUNT), TEST_RES]
...
class Ui_MicrobialAnalysis(object):
    ...
    def retranslateUi(self, MicrobialAnalysis):
        ...
        self.sampleNumber.setText(_translate("MicrobialAnalysis", ""))
        self.clientName.setText(_translate("MicrobialAnalysis", ""))
        self.passFail.setText(_translate("MicrobialAnalysis", ""))
        self.colonyCount.setText(_translate("MicrobialAnalysis", ""))
    ...
    def reset_clicked(self):
        ...
        self.sampleNumber.setText("")
        self.colonyCount.setText("")
        self.passFail.setText("")
    ...
    def next_sample(self):
        ...
        self.sampleImage.setPixmap(QPixmap(os.path.join(directory, imageName)))
        CUR_SAMPLE += 1
        self.progressBar.setValue(((CUR_SAMPLE) / (TOTAL_SAMPLES))*100)
